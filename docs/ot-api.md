  ...
  "properties" : {
    ...
    "options" : {
      ...
      "items" : {
        ...
        defs["InstanceLoggingOptionItem"] = {
  "type" : "object",
  "properties" : {
    "name" : {
      "type" : "string"
  ...
  "properties" : {
    ...
    "lastEnd" : {
      ...
      "format" : "int64"
        ...
        defs["SupportedTransformationItem"] = {
  "type" : "object",
  "properties" : {
    "name" : {
      "type" : "string"
      ...
      <div id="sidenav" class="span2">
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            <!-- Logo Area -->
              <div style="width: 80%; background-color: #87de87; color: white; padding: 20px; text-align: center; margin-bottom: 20px; ">

              <IMG SRC ="img/pixel_rthd_icon2.png"/>

              </div>
            
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>

                  <li class="nav-header" data-group="InstanceResource"><a href="#api-InstanceResource">API Methods - Instance</a></li>
                    <li data-group="InstanceResource" data-name="createInstance" class="">
                      <a href="#api-InstanceResource-createInstance">createInstance</a>
                    </li>
                    <li data-group="InstanceResource" data-name="deleteInstance" class="">
                      <a href="#api-InstanceResource-deleteInstance">deleteInstance</a>
                    </li>
                    <li data-group="InstanceResource" data-name="getInstance" class="">
                      <a href="#api-InstanceResource-getInstance">getInstance</a>
                    </li>
                    <li data-group="InstanceResource" data-name="listInstances" class="">
                      <a href="#api-InstanceResource-listInstances">listInstances</a>
                    </li>
                    <li data-group="InstanceResource" data-name="updateInstance" class="">
                      <a href="#api-InstanceResource-updateInstance">updateInstance</a>
                    </li>
                  <li class="nav-header" data-group="KPIResource"><a href="#api-KPIResource">API Methods - KPI</a></li>
                    <li data-group="KPIResource" data-name="createKPI" class="">
                      <a href="#api-KPIResource-createKPI">createKPI</a>
                    </li>
                    <li data-group="KPIResource" data-name="deleteKPI" class="">
                      <a href="#api-KPIResource-deleteKPI">deleteKPI</a>
                    </li>
                    <li data-group="KPIResource" data-name="getKPIByID" class="">
                      <a href="#api-KPIResource-getKPIByID">getKPIByID</a>
                    </li>
                    <li data-group="KPIResource" data-name="getKPIStatsByID" class="">
                      <a href="#api-KPIResource-getKPIStatsByID">getKPIStatsByID</a>
                    </li>
                    <li data-group="KPIResource" data-name="getLastKPIByID" class="">
                      <a href="#api-KPIResource-getLastKPIByID">getLastKPIByID</a>
                    </li>
                    <li data-group="KPIResource" data-name="listKPIs" class="">
                      <a href="#api-KPIResource-listKPIs">listKPIs</a>
                    </li>
                    <li data-group="KPIResource" data-name="updateKPI" class="">
                      <a href="#api-KPIResource-updateKPI">updateKPI</a>
                    </li>
                  <li class="nav-header" data-group="ModelResource"><a href="#api-ModelResource">API Methods - Model</a></li>
                    <li data-group="ModelResource" data-name="createModel" class="">
                      <a href="#api-ModelResource-createModel">createModel</a>
                    </li>
                    <li data-group="ModelResource" data-name="deleteModel" class="">
                      <a href="#api-ModelResource-deleteModel">deleteModel</a>
                    </li>
                    <li data-group="ModelResource" data-name="getModel" class="">
                      <a href="#api-ModelResource-getModel">getModel</a>
                    </li>
                    <li data-group="ModelResource" data-name="getModelInfo" class="">
                      <a href="#api-ModelResource-getModelInfo">getModelInfo</a>
                    </li>
                    <li data-group="ModelResource" data-name="listModels" class="">
                      <a href="#api-ModelResource-listModels">listModels</a>
                    </li>
                    <li data-group="ModelResource" data-name="updateModel" class="">
                      <a href="#api-ModelResource-updateModel">updateModel</a>
                    </li>
                  <li class="nav-header" data-group="ScheduledInstanceResource"><a href="#api-ScheduledInstanceResource">API Methods - ScheduledInstance</a></li>
                    <li data-group="ScheduledInstanceResource" data-name="createScheduledInstance" class="">
                      <a href="#api-ScheduledInstanceResource-createScheduledInstance">createScheduledInstance</a>
                    </li>
                    <li data-group="ScheduledInstanceResource" data-name="deleteScheduledInstance" class="">
                      <a href="#api-ScheduledInstanceResource-deleteScheduledInstance">deleteScheduledInstance</a>
                    </li>
                    <li data-group="ScheduledInstanceResource" data-name="getScheduledInstance" class="">
                      <a href="#api-ScheduledInstanceResource-getScheduledInstance">getScheduledInstance</a>
                    </li>
                    <li data-group="ScheduledInstanceResource" data-name="listScheduledInstances" class="">
                      <a href="#api-ScheduledInstanceResource-listScheduledInstances">listScheduledInstances</a>
                    </li>
                    <li data-group="ScheduledInstanceResource" data-name="updateScheduledInstance" class="">
                      <a href="#api-ScheduledInstanceResource-updateScheduledInstance">updateScheduledInstance</a>
                    </li>
                    <li data-group="ScheduledInstanceResource" data-name="updateStatusScheduledInstance" class="">
                      <a href="#api-ScheduledInstanceResource-updateStatusScheduledInstance">updateStatusScheduledInstance</a>
                    </li>
          </ul>
        </nav>
      </div>
        ...
        <div id="header">
          <div id="api-_">
            <h2 id="welcome-to-apidoc">API and SDK Documentation</h2>
              <!-- <div class="app-desc">Version: 0.6.0</div> -->
            <hr>
            <div>The OT uses a REST API. All endpoints require authentication. The Authorization HTTP header can be specified with ApiKey <your-key> to authenticate as a user and have the same permissions that the user itself.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-InstanceResource">
                  <h1>InstanceResource</h1>
                    <div id="api-InstanceResource-createInstance">
                      <article id="api-InstanceResource-createInstance-0" data-group="User" data-name="createInstance" data-version="0">
                        <div class="pull-left">
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">If id is not provided, it will be randomly generated</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/instances/create</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-InstanceResource-createInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-createInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-createInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-InstanceResource-createInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-InstanceResource-createInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/instances/create"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-InstanceResource-createInstance-0-java">
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-InstanceResource-createInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.InstanceResourceApi;
...
public class InstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-InstanceResource-createInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-objc">
...
[apiInstance createInstanceWith:body
              completionHandler: ^(Instance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
...
api.createInstance(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-InstanceResource-createInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-csharp">
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling InstanceResourceApi.createInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-php">
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-perl">
...
if ($@) {
    warn "Exception when calling InstanceResourceApi->createInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-createInstance-0-python">
...
$(document).ready(function() {
  ...
  var result = $('#d2e199_createInstance_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createInstance_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createInstance-200-schema">
                                  <div id='responses-createInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  ...
  "schema" : {
    "$ref" : "#/definitions/Instance"
                                        ...
                                        $('#responses-createInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Instance already exists </h3>
                            ...
                            <h3> Status: 500 - Internal error </h3>
                      ...
                      <hr>
                    <div id="api-InstanceResource-deleteInstance">
                      <article id="api-InstanceResource-deleteInstance-0" data-group="User" data-name="deleteInstance" data-version="0">
                        <div class="pull-left">
                          <h1>deleteInstance</h1>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/instances/delete/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-InstanceResource-deleteInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-deleteInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-deleteInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-InstanceResource-deleteInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-InstanceResource-deleteInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/instances/delete/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.InstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.InstanceResourceApi;
...
public class InstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance deleteInstanceWith:id
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.deleteInstance(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling InstanceResourceApi.deleteInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::InstanceResourceApi;
...
if ($@) {
    warn "Exception when calling InstanceResourceApi->deleteInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-deleteInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_deleteInstance_id">
            ...
            <div class="primitive">
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Instance not found </h3>
                      ...
                      <hr>
                    <div id="api-InstanceResource-getInstance">
                      <article id="api-InstanceResource-getInstance-0" data-group="User" data-name="getInstance" data-version="0">
                        <div class="pull-left">
                          <h1>getInstance</h1>
                          <p>Get an instance by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/instances/get/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-InstanceResource-getInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-getInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-getInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-InstanceResource-getInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-InstanceResource-getInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/instances/get/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-InstanceResource-getInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.InstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-InstanceResource-getInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.InstanceResourceApi;
...
public class InstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-InstanceResource-getInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getInstanceWith:id
              completionHandler: ^(Instance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getInstance(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-InstanceResource-getInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling InstanceResourceApi.getInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::InstanceResourceApi;
...
if ($@) {
    warn "Exception when calling InstanceResourceApi->getInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-getInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getInstance-200-schema">
                                  <div id='responses-getInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Instance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-InstanceResource-listInstances">
                      <article id="api-InstanceResource-listInstances-0" data-group="User" data-name="listInstances" data-version="0">
                        <div class="pull-left">
                          <h1>listInstances</h1>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/instances/list</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-InstanceResource-listInstances-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-java">Java</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-listInstances-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-listInstances-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-php">PHP</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-InstanceResource-listInstances-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-InstanceResource-listInstances-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/instances/list?idRef=&user=&status="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-InstanceResource-listInstances-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.InstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-InstanceResource-listInstances-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.InstanceResourceApi;
...
public class InstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-InstanceResource-listInstances-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance listInstancesWith:idRef
    ...
    status:status
              completionHandler: ^(array[Instance] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.listInstances(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-InstanceResource-listInstances-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling InstanceResourceApi.listInstances: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::InstanceResourceApi;
...
if ($@) {
    warn "Exception when calling InstanceResourceApi->listInstances: $@\n";
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-listInstances-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">idRef</td>
<td>


    <div id="d2e199_listInstances_idRef">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_listInstances_user">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_listInstances_status">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        status
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listInstances-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listInstances-200-schema">
                                  <div id='responses-listInstances-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Instance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listInstances-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listInstances-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listInstances-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-InstanceResource-updateInstance">
                      <article id="api-InstanceResource-updateInstance-0" data-group="User" data-name="updateInstance" data-version="0">
                        <div class="pull-left">
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/instances/update</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-InstanceResource-updateInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-updateInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-InstanceResource-updateInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-InstanceResource-updateInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-InstanceResource-updateInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/instances/update"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.InstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.InstanceResourceApi;
...
public class InstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateInstanceWith:body
              completionHandler: ^(Instance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.updateInstance(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-InstanceResource-updateInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling InstanceResourceApi.updateInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::InstanceResourceApi;
...
if ($@) {
    warn "Exception when calling InstanceResourceApi->updateInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-InstanceResource-updateInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateInstance_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateInstance_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-updateInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-updateInstance-200-schema">
                                  <div id='responses-updateInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Instance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-updateInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-updateInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-updateInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-KPIResource">
                  <h1>KPIResource</h1>
                    <div id="api-KPIResource-createKPI">
                      <article id="api-KPIResource-createKPI-0" data-group="User" data-name="createKPI" data-version="0">
                        <div class="pull-left">
                          <h1>createKPI</h1>
                          <p>Create a KPI</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/kpis/create</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-createKPI-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-createKPI-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-createKPI-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-createKPI-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-createKPI-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-createKPI-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-createKPI-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/create"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-createKPI-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-createKPI-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-createKPI-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance createKPIWith:body
              completionHandler: ^(KPI output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.createKPI(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-createKPI-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.createKPI: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->createKPI: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-createKPI-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createKPI_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createKPI_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createKPI-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createKPI-200-schema">
                                  <div id='responses-createKPI-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/KPI"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-createKPI-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createKPI-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createKPI-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - KPI already exists </h3>
                      ...
                      <hr>
                    <div id="api-KPIResource-deleteKPI">
                      <article id="api-KPIResource-deleteKPI-0" data-group="User" data-name="deleteKPI" data-version="0">
                        <div class="pull-left">
                          <h1>deleteKPI</h1>
                          <p>Delete a kpi</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/kpis/delete/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-deleteKPI-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-deleteKPI-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-deleteKPI-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-deleteKPI-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-deleteKPI-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/delete/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance deleteKPIWith:id
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.deleteKPI(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-deleteKPI-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.deleteKPI: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->deleteKPI: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-deleteKPI-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
            ...
            <div class="primitive">
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - KPI not found </h3>
                      ...
                      <hr>
                    <div id="api-KPIResource-getKPIByID">
                      <article id="api-KPIResource-getKPIByID-0" data-group="User" data-name="getKPIByID" data-version="0">
                        <div class="pull-left">
                          <h1>getKPIByID</h1>
                          <p>Get a KPI by id</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/kpis/get/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-getKPIByID-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getKPIByID-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getKPIByID-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIByID-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-getKPIByID-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/get/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getKPIByIDWith:id
              completionHandler: ^(KPI output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getKPIByID(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-getKPIByID-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.getKPIByID: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->getKPIByID: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIByID-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getKPIByID-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getKPIByID-200-schema">
                                  <div id='responses-getKPIByID-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/KPI"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getKPIByID-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getKPIByID-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getKPIByID-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-KPIResource-getKPIStatsByID">
                      <article id="api-KPIResource-getKPIStatsByID-0" data-group="User" data-name="getKPIStatsByID" data-version="0">
                        <div class="pull-left">
                          <h1>getKPIStatsByID</h1>
                          <p>Get stats a KPI</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/kpis/get/{id}/stats</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-getKPIStatsByID-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-getKPIStatsByID-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-getKPIStatsByID-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/get/{id}/stats?from=&to="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getKPIStatsByIDWith:id
    ...
    to:to
              completionHandler: ^(JsonNode output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getKPIStatsByID(id, opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.getKPIStatsByID: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->getKPIStatsByID: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getKPIStatsByID-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_getKPIStatsByID_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_getKPIStatsByID_from">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_getKPIStatsByID_to">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        to
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getKPIStatsByID-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getKPIStatsByID-200-schema">
                                  <div id='responses-getKPIStatsByID-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/JsonNode"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getKPIStatsByID-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getKPIStatsByID-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getKPIStatsByID-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-KPIResource-getLastKPIByID">
                      <article id="api-KPIResource-getLastKPIByID-0" data-group="User" data-name="getLastKPIByID" data-version="0">
                        <div class="pull-left">
                          <h1>getLastKPIByID</h1>
                          <p>Get the last value of a KPI by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/kpis/get/{id}/lastKPI</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-getLastKPIByID-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getLastKPIByID-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-getLastKPIByID-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-getLastKPIByID-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-getLastKPIByID-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/get/{id}/lastKPI"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getLastKPIByIDWith:id
              completionHandler: ^(JsonNode output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getLastKPIByID(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.getLastKPIByID: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->getLastKPIByID: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-getLastKPIByID-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_getLastKPIByID_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getLastKPIByID-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getLastKPIByID-200-schema">
                                  <div id='responses-getLastKPIByID-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/JsonNode"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getLastKPIByID-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getLastKPIByID-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getLastKPIByID-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-KPIResource-listKPIs">
                      <article id="api-KPIResource-listKPIs-0" data-group="User" data-name="listKPIs" data-version="0">
                        <div class="pull-left">
                          <h1>listKPIs</h1>
                          <p>List all models</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/kpis/list</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-listKPIs-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-listKPIs-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-listKPIs-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-listKPIs-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-listKPIs-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/list?category="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-listKPIs-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-listKPIs-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-listKPIs-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance listKPIsWith:category
              completionHandler: ^(array[KPI] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.listKPIs(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-listKPIs-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.listKPIs: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->listKPIs: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-listKPIs-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">category</td>
<td>


    <div id="d2e199_listKPIs_category">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        category
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listKPIs-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listKPIs-200-schema">
                                  <div id='responses-listKPIs-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/KPI"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listKPIs-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listKPIs-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listKPIs-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-KPIResource-updateKPI">
                      <article id="api-KPIResource-updateKPI-0" data-group="User" data-name="updateKPI" data-version="0">
                        <div class="pull-left">
                          <h1>updateKPI</h1>
                          <p>Update a kpi</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/kpis/update</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-KPIResource-updateKPI-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-java">Java</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-updateKPI-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-KPIResource-updateKPI-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-php">PHP</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-KPIResource-updateKPI-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-KPIResource-updateKPI-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/kpis/update"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-KPIResource-updateKPI-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.KPIResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-KPIResource-updateKPI-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.KPIResourceApi;
...
public class KPIResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-KPIResource-updateKPI-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateKPIWith:body
              completionHandler: ^(KPI output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.updateKPI(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-KPIResource-updateKPI-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling KPIResourceApi.updateKPI: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::KPIResourceApi;
...
if ($@) {
    warn "Exception when calling KPIResourceApi->updateKPI: $@\n";
                            ...
                            <div class="tab-pane" id="examples-KPIResource-updateKPI-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateKPI_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateKPI_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-updateKPI-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-updateKPI-200-schema">
                                  <div id='responses-updateKPI-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/KPI"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-updateKPI-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-updateKPI-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-updateKPI-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-ModelResource">
                  <h1>ModelResource</h1>
                    <div id="api-ModelResource-createModel">
                      <article id="api-ModelResource-createModel-0" data-group="User" data-name="createModel" data-version="0">
                        <div class="pull-left">
                          <h1>createModel</h1>
                          <p>Create a model</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/models/create</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-createModel-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-createModel-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-createModel-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-createModel-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-createModel-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-createModel-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-createModel-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/create"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-createModel-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-createModel-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-createModel-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance createModelWith:body
              completionHandler: ^(Model output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.createModel(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-createModel-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.createModel: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->createModel: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-createModel-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createModel_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createModel_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createModel-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createModel-200-schema">
                                  <div id='responses-createModel-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Model"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-createModel-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createModel-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createModel-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Model already exists </h3>
                      ...
                      <hr>
                    <div id="api-ModelResource-deleteModel">
                      <article id="api-ModelResource-deleteModel-0" data-group="User" data-name="deleteModel" data-version="0">
                        <div class="pull-left">
                          <h1>deleteModel</h1>
                          <p>Delete a model</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/models/delete/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-deleteModel-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-deleteModel-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-deleteModel-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-deleteModel-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-deleteModel-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/delete/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-deleteModel-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ModelResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-deleteModel-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-deleteModel-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance deleteModelWith:id
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.deleteModel(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-deleteModel-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.deleteModel: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ModelResourceApi;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->deleteModel: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-deleteModel-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
            ...
            <div class="primitive">
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Model not found </h3>
                      ...
                      <hr>
                    <div id="api-ModelResource-getModel">
                      <article id="api-ModelResource-getModel-0" data-group="User" data-name="getModel" data-version="0">
                        <div class="pull-left">
                          <h1>getModel</h1>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/models/get/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-getModel-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-getModel-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-getModel-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-getModel-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-getModel-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-getModel-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-getModel-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/get/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-getModel-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ModelResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-getModel-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-getModel-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getModelWith:id
              completionHandler: ^(Model output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getModel(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-getModel-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.getModel: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ModelResourceApi;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->getModel: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModel-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getModel-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getModel-200-schema">
                                  <div id='responses-getModel-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Model"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getModel-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getModel-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getModel-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ModelResource-getModelInfo">
                      <article id="api-ModelResource-getModelInfo-0" data-group="User" data-name="getModelInfo" data-version="0">
                        <div class="pull-left">
                          <h1>getModelInfo</h1>
                          <p>Get information of a model by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/models/get/{id}/info</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-getModelInfo-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-getModelInfo-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-getModelInfo-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-getModelInfo-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-getModelInfo-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/get/{id}/info"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ModelResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getModelInfoWith:id
              completionHandler: ^(GeneralInfo output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getModelInfo(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-getModelInfo-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.getModelInfo: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ModelResourceApi;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->getModelInfo: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-getModelInfo-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getModelInfo-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getModelInfo-200-schema">
                                  <div id='responses-getModelInfo-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/GeneralInfo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getModelInfo-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getModelInfo-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getModelInfo-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ModelResource-listModels">
                      <article id="api-ModelResource-listModels-0" data-group="User" data-name="listModels" data-version="0">
                        <div class="pull-left">
                          <h1>listModels</h1>
                          <p>List all models</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/models/list</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-listModels-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-listModels-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-listModels-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-listModels-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-listModels-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-listModels-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-listModels-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/list?otStatus=&type="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-listModels-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ModelResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-listModels-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-listModels-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance listModelsWith:otStatus
    type:type
              completionHandler: ^(array[Model] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.listModels(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-listModels-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.listModels: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ModelResourceApi;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->listModels: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-listModels-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">otStatus</td>
<td>


    <div id="d2e199_listModels_otStatus">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        type
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listModels-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listModels-200-schema">
                                  <div id='responses-listModels-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Model"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listModels-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listModels-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listModels-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ModelResource-updateModel">
                      <article id="api-ModelResource-updateModel-0" data-group="User" data-name="updateModel" data-version="0">
                        <div class="pull-left">
                          <h1>updateModel</h1>
                          <p>Update a model</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/models/update</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ModelResource-updateModel-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-java">Java</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-updateModel-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ModelResource-updateModel-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ModelResource-updateModel-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ModelResource-updateModel-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ModelResource-updateModel-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ModelResource-updateModel-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/models/update"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ModelResource-updateModel-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ModelResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ModelResource-updateModel-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ModelResourceApi;
...
public class ModelResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ModelResource-updateModel-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateModelWith:body
              completionHandler: ^(Model output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.updateModel(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ModelResource-updateModel-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ModelResourceApi.updateModel: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ModelResourceApi;
...
if ($@) {
    warn "Exception when calling ModelResourceApi->updateModel: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ModelResource-updateModel-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateModel_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateModel_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-updateModel-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-updateModel-200-schema">
                                  <div id='responses-updateModel-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Model"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-updateModel-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-updateModel-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-updateModel-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-ScheduledInstanceResource">
                  <h1>ScheduledInstanceResource</h1>
                    <div id="api-ScheduledInstanceResource-createScheduledInstance">
                      <article id="api-ScheduledInstanceResource-createScheduledInstance-0" data-group="User" data-name="createScheduledInstance" data-version="0">
                        <div class="pull-left">
                          <h1>createScheduledInstance</h1>
                          <p>Create a scheduled instance</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/scheduledInstances/create</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-createScheduledInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-createScheduledInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/create"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance createScheduledInstanceWith:body
              completionHandler: ^(Instance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.createScheduledInstance(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.createScheduledInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->createScheduledInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-createScheduledInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_createScheduledInstance_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_createScheduledInstance_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-createScheduledInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-createScheduledInstance-200-schema">
                                  <div id='responses-createScheduledInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/Instance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-createScheduledInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-createScheduledInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-createScheduledInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Scheduled instance already exists </h3>
                      ...
                      <hr>
                    <div id="api-ScheduledInstanceResource-deleteScheduledInstance">
                      <article id="api-ScheduledInstanceResource-deleteScheduledInstance-0" data-group="User" data-name="deleteScheduledInstance" data-version="0">
                        <div class="pull-left">
                          <h1>deleteScheduledInstance</h1>
                          <p>Delete a scheduled instance</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/scheduledInstances/delete/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-deleteScheduledInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/delete/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ScheduledInstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance deleteScheduledInstanceWith:id
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.deleteScheduledInstance(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.deleteScheduledInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ScheduledInstanceResourceApi;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->deleteScheduledInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-deleteScheduledInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_deleteScheduledInstance_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Scheduled instance not found </h3>
                      ...
                      <hr>
                    <div id="api-ScheduledInstanceResource-getScheduledInstance">
                      <article id="api-ScheduledInstanceResource-getScheduledInstance-0" data-group="User" data-name="getScheduledInstance" data-version="0">
                        <div class="pull-left">
                          <h1>getScheduledInstance</h1>
                          <p>Get a scheduled instance by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/scheduledInstances/get/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-getScheduledInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-getScheduledInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/get/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ScheduledInstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance getScheduledInstanceWith:id
              completionHandler: ^(ScheduledInstance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.getScheduledInstance(id, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.getScheduledInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ScheduledInstanceResourceApi;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->getScheduledInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-getScheduledInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_getScheduledInstance_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getScheduledInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getScheduledInstance-200-schema">
                                  <div id='responses-getScheduledInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/ScheduledInstance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getScheduledInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getScheduledInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getScheduledInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ScheduledInstanceResource-listScheduledInstances">
                      <article id="api-ScheduledInstanceResource-listScheduledInstances-0" data-group="User" data-name="listScheduledInstances" data-version="0">
                        <div class="pull-left">
                          <h1>listScheduledInstances</h1>
                          <p>List all scheduled instances</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/scheduledInstances/list</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-listScheduledInstances-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-listScheduledInstances-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/list?idRef=&user=&status="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ScheduledInstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance listScheduledInstancesWith:idRef
    ...
    status:status
              completionHandler: ^(array[ScheduledInstance] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.listScheduledInstances(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.listScheduledInstances: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ScheduledInstanceResourceApi;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->listScheduledInstances: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-listScheduledInstances-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_listScheduledInstances_idRef">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_listScheduledInstances_user">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_listScheduledInstances_status">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        status
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listScheduledInstances-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listScheduledInstances-200-schema">
                                  <div id='responses-listScheduledInstances-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/ScheduledInstance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listScheduledInstances-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listScheduledInstances-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listScheduledInstances-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ScheduledInstanceResource-updateScheduledInstance">
                      <article id="api-ScheduledInstanceResource-updateScheduledInstance-0" data-group="User" data-name="updateScheduledInstance" data-version="0">
                        <div class="pull-left">
                          <h1>updateScheduledInstance</h1>
                          <p>Update a scheduled instance</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/scheduledInstances/update</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateScheduledInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/update"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ScheduledInstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateScheduledInstanceWith:body
              completionHandler: ^(ScheduledInstance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.updateScheduledInstance(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.updateScheduledInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ScheduledInstanceResourceApi;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->updateScheduledInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateScheduledInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateScheduledInstance_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateScheduledInstance_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-updateScheduledInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-updateScheduledInstance-200-schema">
                                  <div id='responses-updateScheduledInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/ScheduledInstance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-updateScheduledInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-updateScheduledInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-updateScheduledInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ScheduledInstanceResource-updateStatusScheduledInstance">
                      <article id="api-ScheduledInstanceResource-updateStatusScheduledInstance-0" data-group="User" data-name="updateStatusScheduledInstance" data-version="0">
                        <div class="pull-left">
                          <h1>updateStatusScheduledInstance</h1>
                          <p>Update only the status of a scheduled instance</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/scheduledInstances/updateStatus/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-java">Java</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST -H "Authorization: [[apiKey]]" "http://&lt;your_tomcat_server&gt;:8080/otpixel/api/scheduledInstances/updateStatus/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ScheduledInstanceResourceApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ScheduledInstanceResourceApi;
...
public class ScheduledInstanceResourceApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateStatusScheduledInstanceWith:id
    status:status
              completionHandler: ^(ScheduledInstance output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var Otpixel = require('otpixel');
var defaultClient = Otpixel.ApiClient.instance;
...
api.updateStatusScheduledInstance(id, status, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ScheduledInstanceResourceApi.updateStatusScheduledInstance: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ScheduledInstanceResourceApi;
...
if ($@) {
    warn "Exception when calling ScheduledInstanceResourceApi->updateStatusScheduledInstance: $@\n";
                            ...
                            <div class="tab-pane" id="examples-ScheduledInstanceResource-updateStatusScheduledInstance-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
<td>
    ...
    <div id="d2e199_updateStatusScheduledInstance_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_updateStatusScheduledInstance_status">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-updateStatusScheduledInstance-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-updateStatusScheduledInstance-200-schema">
                                  <div id='responses-updateStatusScheduledInstance-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "successful operation",
  "schema" : {
    "$ref" : "#/definitions/ScheduledInstance"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-updateStatusScheduledInstance-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-updateStatusScheduledInstance-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-updateStatusScheduledInstance-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
